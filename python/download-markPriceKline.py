...
"""
    ...
    e.g. STORE_DIRECTORY=/data/ ./download-markPriceKline.py
...
def download_monthly_markPriceKlines(trading_type, symbols, num_symbols, intervals, years, months, start_date, end_date, folder, checksum):
    current = 0
    date_range = None
...
def download_daily_markPriceKlines(trading_type, symbols, num_symbols, intervals, dates, start_date, end_date, folder, checksum):
    current = 0
    date_range = None
...
if __name__ == "__main__":
        ...
        if args.dates:
            ...
            download_monthly_markPriceKlines(args.type, symbols, num_symbols, args.intervals, args.years, args.months, args.startDate, args.endDate, args.folder, args.checksum)
        download_daily_markPriceKlines(args.type, symbols, num_symbols, args.intervals, dates, args.startDate, args.endDate, args.folder, args.checksum)
